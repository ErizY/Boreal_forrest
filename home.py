...
with col2:
    ...
    components.html("""
    <ul style="color:#ffff;  font-family: Arial; font-size:11.5px;">
...
""")
    ...
    components.html("""
            <dl style="color:#ffff;  font-family: Arial; font-size:11.5px;">
            <dd style="color:#ffff;  font-family: Arial; vfont-size:11.5px;">This website was created by Eriz Yusuf and Mohammed Mazy under Alan McFetrdige Photography, 
